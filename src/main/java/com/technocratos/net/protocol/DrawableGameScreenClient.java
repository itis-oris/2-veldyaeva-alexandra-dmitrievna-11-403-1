...
public class DrawableGameScreenClient {
    ...
    public void drawStartScreen(Graphics2D g2, int width, int height, boolean ready, List<Player> topPlayers) {
        g2.setColor(new Color(35, 35, 45));
        g2.fillRect(0, 0, width, height);

        g2.setColor(Color.WHITE);
        g2.setFont(new Font("Arial", Font.BOLD, 40));
        String title = "Сетевая игра (Клиент)";
        ...
        if (!ready) {
            ...
            drawLeaderboardTable(g2, width, 450, "Лучшие результаты", false, topPlayers);
        } else {
            ...
            drawLeaderboardTable(g2, width, 300, "Лучшие результаты", false, topPlayers);
        }
    }

    public void drawLeaderboardBeforeStart(Graphics2D g2, int width, int height, int score, boolean gameStart, List<Player> topPlayers) {
        if (gameStart) {
            ...
            drawLeaderboardTable(g2, width, 200, "Топ игроков", true, topPlayers);
        }
    }

    public void drawLeaderboardTable(Graphics2D g2, int width, int startY, String title, boolean isResults, List<Player> topPlayers) {
    ...
    public void drawWaitScreen(Graphics2D g2, int width, int height, boolean clientReady, List<Player> topPlayers) {
        g2.setColor(new Color(35, 35, 45));
        g2.fillRect(0, 0, width, height);
